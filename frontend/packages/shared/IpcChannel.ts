...
export enum IpcChannel {
  ...
  // Screen Monitor
  Screen_Monitor_Check_Permissions = 'screen-monitor:check-permissions',
  ...
  Screen_Monitor_Get_Screenshots_By_Date = 'screen-monitor:get-screenshots-by-date',
  Screen_Monitor_Cleanup_Old_Screenshots = 'screen-monitor:cleanup-old-screenshots',
  Screen_Monitor_Get_Capture_All_Sources = 'screen-monitor:get-capture-all-sources',

  // Database 操作
  Database_GetAllVaults = 'database:get-all-vaults',
  Database_GetVaultsByParentId = 'database:get-vaults-by-parent-id',
  Database_GetVaultById = 'database:get-vault-by-id',
  Database_GetVaultByTitle = 'database:get-vault-by-title',
  Database_InsertVault = 'database:insert-vault',
  Database_UpdateVaultById = 'database:update-vault-by-id',
  Database_DeleteVaultById = 'database:delete-vault-by-id',
  Database_GetFolders = 'database:get-folders',
  Database_CreateFolder = 'database:create-folder',
  ...
  Database_GetNewActivities = 'database:get-new-activities',
  Database_GetLatestActivity = 'database:get-latest-activity',

  // tasks
  Database_GetAllTasks = 'database:get-all-tasks',
  Database_AddTask = 'database:add-task',
  Database_UpdateTask = 'database:update-task',
  Database_DeleteTask = 'database:delete-task',
  Database_ToggleTaskStatus = 'database:toggle-task-status',

  // tips
  Database_GetAllTips = 'database:get-all-tips',

  // Backend 服务相关
  Backend_GetPort = 'backend:get-port',
  Backend_GetStatus = 'backend:get-status',
  Backend_StatusChanged = 'backend:status-changed',
